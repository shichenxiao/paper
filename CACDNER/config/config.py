...
#
__C.DATASET = edict()
__C.DATASET.NUM_CLASSES =9
__C.DATASET.DATAROOT = '../experiments/process_data'
__C.DATASET.SOURCE_NAME = 'Conll2003/train.json'
__C.DATASET.TRAIN_SOURCE_NAME = 'OntoNotesNER/aug_data/train_aug.bmes'

__C.DATASET.TARGET_NAME = 'SciTech/train.json'
__C.DATASET.DEV_SOURCE_NAME = 'Conll2003/dev.json'
__C.DATASET.DEV_TARGET_NAME = 'SciTech/dev.json'

# Model options
__C.MODEL = edict()
__C.MODEL.PRETRAINED_PATH = '../bert-base-uncased'
...
__C.TRAIN = edict()
# batch size setting
__C.TRAIN.SOURCE_BATCH_SIZE = 100
__C.TRAIN.TARGET_BATCH_SIZE = 20
__C.TRAIN.TARGET_CLASS_BATCH_SIZE = 128
__C.TRAIN.SOURCE_CLASS_BATCH_SIZE = 128
...
__C.TRAIN.UPDATE_EPOCH_PERCENTAGE = 0.05  #1.0
__C.TRAIN.DROPOUT=0.5
__C.TRAIN.HIDDEN_SIZE=768
...
__C.CLUSTERING.TARGET_BATCH_SIZE = 30
__C.CLUSTERING.SOURCE_BATCH_SIZE = 30
...
__C.TEST.DOMAIN = ''
__C.TEST.SOURCE = 'Conll2003/test.json'
__C.TEST.TARGET = 'SciTech/test.json'
