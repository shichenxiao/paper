...
preprocess("../experiments/OntoNotesNER/train.char.bmes", '../experiments/OntoNotesNER/raw_data', "train")
preprocess("../experiments/OntoNotesNER/dev.char.bmes", '../experiments/OntoNotesNER/raw_data', "dev")
preprocess("../experiments/OntoNotesNER/test.char.bmes", '../experiments/OntoNotesNER/raw_data', "test")
